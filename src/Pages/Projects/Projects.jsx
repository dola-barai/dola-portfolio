                            ...
                            <div className=" lg:card-side bg-purple-950">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className=' py-3'>
                                        ...
                                        <h2 className='text-white text-justify py-3'><span className='font-semibold'>Adding Doll Toys: </span>Users, after creating an account, can add doll toys to the platform using an "AddToy" page. This feature allows sellers to showcase their products and make them available for purchase on the website.</h2>
